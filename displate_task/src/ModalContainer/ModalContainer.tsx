...
import { Button, Loader, Modal, ModalActions, ModalContent, ModalHeader } from 'semantic-ui-react';
...
const ModalContainer = ({
    ...
    resetClickedPhoto, resetRandomPhoto, setModalOpen }: TModalContainer) => (
    <Fragment>
        <Modal
            className="Modal"
            size="large"
