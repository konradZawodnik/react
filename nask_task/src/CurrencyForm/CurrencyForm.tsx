...
const CurrencyForm = () => {
    const [result, setResult] = useState<string | number | string[] | undefined>(undefined);
    const [fromCurrency, setFromCurrency] = useState<string>("USD");
    const [toCurrency, setToCurrency] = useState<string>('GBP');
    const [amount, setAmmount] = useState<string | number | string[] | undefined>(undefined);
    const [currencies, setCurrencies] = useState<Array<{}>>([]);
    const [loading, setLoading] = useState<boolean>(false);
    const [errorModalOpen, setErrorModalOpen] = useState<boolean>(false);

    const onlyNumberKey = debounce(useCallback((e: any) => {
