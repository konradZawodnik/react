 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://soa/", wsdlLocation = "http://localhost:8080/WebApplication1/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://soa/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://soa/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soa/", "NewWebServicePort"), NewWebService.class, features);
    }
